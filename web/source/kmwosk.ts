...
if(!window['keyman']['initialized']) {
    ...
    **/
    ...
    osk.clickKey = function(e) {
      ...
      if(Lelem != null) {
        ...
        console.log("[Touch] Starting keystroke processing for key " + e.id);
  ...
  //TODO: Still drags Android background sometimes (not consistently)
      ...
      kb.addEventListener('touchcancel', touchEnd, false);
    }
    ...
    osk.deviceDependentLayout=function(layout,formFactor)
    {
        ...
        {                                                          // Not to mention, it's rather redundant.
          ...
          lDiv.addEventListener('touchmove', function(e) {
            console.log("[Touch] Move");            
            osk.moveOver(e);
          }, false);
          lDiv.addEventListener('touchcancel', function(e) {
            console.log("[Touch] Cancel");            
            osk.cancel(e);
          }, false); //event never generated by iOS
        }
